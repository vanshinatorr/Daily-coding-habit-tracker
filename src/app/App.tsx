        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-3">
              <button className="px-5 py-2.5 text-sm text-zinc-300 hover:text-white transition-colors">
                Sign In
              </button>
              <button className="px-5 py-2.5 bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-400 hover:to-purple-500 text-white font-semibold rounded-lg text-sm transition-all duration-300 shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50">
                Start Free
              </button>
            </div>
            ...
            <div className="md:hidden absolute top-full left-0 right-0 bg-[#0D0D0F]/95 backdrop-blur-xl border-b border-white/10 py-6 px-6">
              <div className="flex flex-col gap-4">
                ...
                <div className="pt-4 border-t border-white/10 flex flex-col gap-3">
                  <button className="px-5 py-2.5 text-sm text-zinc-300 hover:text-white transition-colors text-left">
                    Sign In
                  </button>
                  <button className="px-5 py-2.5 bg-gradient-to-r from-violet-500 to-purple-600 text-white font-semibold rounded-lg text-sm">
                    Start Free
                  </button>
                </div>
              </div>
